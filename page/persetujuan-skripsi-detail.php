            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <h1>Pilih skripsi yang disetujui</h1>
                    </div>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-toggle="true" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="controller/act-persetujuan-skripsi.php?id_pengajuan=<?php echo $id_pengajuan; ?>&judul_skripsi=<?php echo $rr['judul_skripsi']; ?>" onclick="return confirm('Yakin ingin menyetujui skripsi <?php echo $rr['judul_skripsi']; ?>?')" class="btn btn-custon-rounded-three btn-primary"><i class="fa fa-square"></i>&nbsp;</a></td>
                                    </tr>
                                <?php
                                    }
                                ?>
